...
var PortalWithState = function (_React$Component) {
  ...
  function PortalWithState(props) {
    ...
    _this.handleOutsideMouseRightClick = _this.handleOutsideMouseRightClick.bind(_this);
  ...
  _createClass(PortalWithState, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.closeOnOutsideRightClick) {
        document.addEventListener('contextmenu', this.handleOutsideMouseRightClick);
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      if (this.props.closeOnOutsideRightClick) {
        document.removeEventListener('contextmenu', this.handleOutsideMouseRightClick);
      }
    }
  }, {
    key: 'openPortal',
    ...
    key: 'handleOutsideMouseRightClick',
    value: function handleOutsideMouseRightClick(e) {
      if (!this.state.active) {
        return;
      }
      var root = this.portalNode.defaultNode;
...
PortalWithState.propTypes = {
  ...
  closeOnOutsideRightClick: _propTypes2.default.bool,
